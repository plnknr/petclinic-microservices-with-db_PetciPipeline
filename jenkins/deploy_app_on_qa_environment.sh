...
AWS_REGION=$AWS_REGION helm repo add stable-petclinic s3://petclinic-helm-charts-petclinic-helm-charts-pelink/stable/myapp/ || echo "repository name already exists"
